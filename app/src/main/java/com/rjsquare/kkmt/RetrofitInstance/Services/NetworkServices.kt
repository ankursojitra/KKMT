...
//    companion object {
        ...
        interface PriceListService {
            @POST("api-price-list")
            @FormUrlEncoded
            fun PriceListData(@FieldMap params: Map<String, String>,@Header("token") token:String): Call<PrizeList_Model>
        ...
        interface StoreListService {
            @POST("api-store")
            @FormUrlEncoded
            fun StoreListData(@FieldMap params: Map<String, String>,@Header("token") token:String): Call<StoreList_Model>
        ...
        interface ItemRedeemService {
            ...
            @FormUrlEncoded
            fun ItemRedeemData(@FieldMap params: Map<String, String>,@Header("token") token:String): Call<ItemRedeem_Model>
